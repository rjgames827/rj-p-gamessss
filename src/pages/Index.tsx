...
const getInitialCategory = (): Category => {
  ...
  // Only return 'support' if path is empty (root URL), otherwise return the first valid category
...
const App: React.FC = () => {
  ...
  useEffect(() => {
    ...
    // Don't redirect - let getInitialCategory handle the initial route
  }, [user, isAuthReady]);
